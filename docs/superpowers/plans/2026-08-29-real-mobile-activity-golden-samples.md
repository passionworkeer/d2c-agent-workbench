...
- [ ] **Step 3: Copy original references unchanged**
...
- [ ] **Step 4: Author exact crop manifests**
...
- [ ] **Step 5: Author PRDs and complete ActivitySpecs**
...
- [ ] **Step 3: Add alias and test configuration**
...
- [ ] **Step 5: Implement card components**
...
- [ ] **Step 1: Add failing page behavior and structure tests**
...
- [ ] **Step 3: Implement `CommerceFeedExperience`**
...
- [ ] **Step 4: Implement `SummerGameFestivalExperience`**
...
- [ ] **Step 5: Implement `PetRedPacketExperience`**
...
- [ ] **Step 6: Implement measured mobile CSS**
...
- [ ] **Step 1: Write failing registration and source-map tests**
...
- [ ] **Step 4: Add composite mapping locator inheritance**
...
- [ ] **Step 5: Add web golden sample payloads**
...
- [ ] **Step 1: Add failing image-normalization tests**
...
- [ ] **Step 2: Run evaluator/orchestrator tests and verify RED**
...
- [ ] **Step 3: Implement in-memory normalization**
...
- [ ] **Step 4: Derive pHash after asset copy**
...
- [ ] **Step 2: Add failing semantic-review tests**
...
- [ ] **Step 5: Implement semantic review**
...
- [ ] **Step 1: Add failing workflow and UI tests**
...
- [ ] **Step 3: Add the semantic adapter**
...
- [ ] **Step 1: Add failing self-contained bundle tests**
...
- [ ] **Step 4: Make workbench download assets**
...
- [ ] **Step 1: Add failing pure importer tests**
...
- [ ] **Step 4: Implement plugin runtime and UI**
...
- [ ] **Step 5: Build three pre-generated bundles**
...
- [ ] **Step 4: Implement thumbnail selector and phone preview**
...
- [ ] **Step 6: Run real-page E2E and tune only measured differences**
